...
const CONFIG = {
    ...
    // You can use emojis! 💗 💓 💞 💕
    pageTitle: "Will You Be My Valentine? ❤️ I couldn't wait! Too worried someone is going to ask you before me!!",
    ...
    questions: {
        ...
        third: {
            text: "Will you be my Valentine on February 14th, 2026? And every other year? ", // The big question!
            yesBtn: "Yes!",                                             // Text for "Yes" button
            noBtn: "No"                                                 // Text for "No" button
        }
    },
